...
<CodeGroup>
```bash cURL
curl -X POST https://linkhealthmonitor.com/api/v1/crawls \
...
<CodeGroup>
```bash cURL
curl "https://linkhealthmonitor.com/api/v1/crawls?status=completed&limit=10" \
  -H "Authorization: Bearer lhm_your_api_key"
```
...
<CodeGroup>
```bash cURL
curl https://linkhealthmonitor.com/api/v1/crawls/7c9e6679-7425-40de-944b-e07fc1f90ae7 \
  -H "Authorization: Bearer lhm_your_api_key"
```
...
<CodeGroup>
```bash cURL
curl "https://linkhealthmonitor.com/api/v1/crawls/7c9e6679-7425-40de-944b-e07fc1f90ae7/links?is_broken=true" \
  -H "Authorization: Bearer lhm_your_api_key"
```
...
<CodeGroup>
```bash cURL
curl https://linkhealthmonitor.com/api/v1/crawls/7c9e6679-7425-40de-944b-e07fc1f90ae7/broken \
  -H "Authorization: Bearer lhm_your_api_key"
```
