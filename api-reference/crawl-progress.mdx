...
```bash
curl -X GET \
  "https://api.linkhealthmonitor.com/v1/crawl/456e4567-e89b-12d3-a456-426614174100/progress" \
...
async function waitForCrawlComplete(crawlId, pollInterval = 5000) {
  while (true) {
    const response = await fetch(
      `https://api.linkhealthmonitor.com/v1/crawl/${crawlId}/progress`,
      {
        headers: {
...
```bash
curl -X POST \
  "https://api.linkhealthmonitor.com/v1/crawl/456e4567-e89b-12d3-a456-426614174100/cancel" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
