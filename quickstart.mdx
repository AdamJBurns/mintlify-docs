...
This guide walks you through setting up Link Health Monitor from account creation to your first crawl results. By the end, you'll have a complete picture of your website's link health.
...
<Steps>
  <Step title="Create Your Account">
    Visit [app.linkhealthmonitor.com](https://app.linkhealthmonitor.com/signup) and sign up with your email or continue with Google/GitHub authentication.
