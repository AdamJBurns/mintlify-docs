...
Run manual and scheduled crawls on your domains.

Crawls are automated scans that discover and analyze every link on your domain. Start manually for immediate results, or schedule for automatic execution.
