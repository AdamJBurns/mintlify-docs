...
Share crawl results with team members, clients, or stakeholders who don't have direct access to Link Health Monitor. Generate shareable links, export PDFs, or use white-labeled reports for client presentations.
...
**Share Link Format:**
```
https://app.linkhealthmonitor.com/share/abc123xyz
```
...
---
Generated by Link Health Monitor
...
curl -X GET \
  https://api.linkhealthmonitor.com/v1/crawls/{crawl_id}/results \
