...
<Accordion title="Record was added to wrong location">
  ...
  **Common mistakes**:
  ...
  |---------|---------|-----------|
  | Wrong host | `_lhm-verify.example.com` | `_lhm-verify` |
  | Added to www | `_lhm-verify.www` | `_lhm-verify` |
  | Full URL | `_lhm-verify.example.com.` | `_lhm-verify` |
  
  **Solution**: Delete the incorrect record and create a new one with just `_lhm-verify` as the host/name.
</Accordion>
...
<Accordion title="Token was copy/pasted incorrectly">
  ...
  **Solution**:
  ...
  Not:
  ```
  lhm-site-verification= abc123xyz789    (extra space)
  lhm-site-verification=abc123           (incomplete)
...
<Tabs>
  <Tab title="Using dig (recommended)">
    ...
    dig TXT _lhm-verify.example.com @8.8.8.8 +short
    
    # Verbose output for debugging
    dig TXT _lhm-verify.example.com +noall +answer
    ```
  ...
  <Tab title="Using nslookup (Windows)">
    ...
    # Using Google's DNS
    nslookup -type=TXT _lhm-verify.example.com 8.8.8.8
    ```
  </Tab>
  ...
  <Tab title="Online tools">
    ...
    2. Enter: `_lhm-verify.example.com`
    3. Select: `TXT`
    4. Click: Search
...
2. Copy the expected value from Link Health Monitor
...
dig TXT _lhm-verify.example.com @8.8.8.8 +short      # Google
dig TXT _lhm-verify.example.com @1.1.1.1 +short      # Cloudflare
dig TXT _lhm-verify.example.com @9.9.9.9 +short      # Quad9
dig TXT _lhm-verify.example.com @208.67.222.222 +short # OpenDNS
```
...
<AccordionGroup>
  ...
  <Accordion title="Route 53: Quotes and formatting">
    ...
    **Correct**: `"lhm-site-verification=abc123"`  
    **Wrong**: `lhm-site-verification=abc123`
  </Accordion>
...
<Steps>
  <Step title="Gather Information">
    ...
    - Output of `dig TXT _lhm-verify.yourdomain.com`
    - Your DNS provider name
  </Step>
  
  <Step title="Contact Support">
    Email [support@linkhealthmonitor.com](mailto:support@linkhealthmonitor.com) with:
