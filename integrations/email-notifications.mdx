...
3. Verify installation with Link Health Monitor
...
<AccordionGroup>
  <Accordion title="Not receiving emails">
    ...
    2. Add `notifications@linkhealthmonitor.com` to contacts
...
```bash
curl -X GET \
  "https://api.linkhealthmonitor.com/v1/settings/notifications" \
