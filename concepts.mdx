---
title: 'Core Concepts'
description: 'Understand the fundamentals of SEO Crawler'
icon: 'book'
---

## Overview

Before diving into SEO Crawler's features, it's helpful to understand the core concepts that power the platform. This page explains the key terminology and how different components work together.

## Domains

A **domain** represents a website you want to monitor. Each domain is a unique property in your SEO Crawler account.
