...
Understand the fundamentals of SEO Crawler.

Before diving into features, understand the core concepts that power the platform. This page explains key terminology and how components work together.
