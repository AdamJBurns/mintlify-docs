...
Anchor text—the clickable text in a hyperlink—tells both users and search engines what to expect on the linked page. Poor anchor text hurts usability and wastes SEO opportunities.
