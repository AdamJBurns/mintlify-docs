...
Anchor text—the clickable text in a hyperlink—tells both users and search engines what to expect on the linked page. Poor anchor text hurts usability and wastes SEO opportunities. Link Health Monitor analyzes your anchor text quality and identifies issues.
...
| **Branded** | `<a href="/about">About LinkHealthMonitor</a>` | Medium |
