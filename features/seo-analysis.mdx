...
SEO Crawler analyzes every page for SEO best practices, identifying issues that could hurt your search visibility.
...
- **Display Results** — Titles and descriptions appear in search
...
<Steps>
  ...
  <Step title="Single H1 Per Page">
    One descriptive H1 that summarizes page topic
  </Step>
...
<Tip>
If the same issue appears on many pages, consider:
