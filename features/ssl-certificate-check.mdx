...
SSL Certificate Check monitors your domain's HTTPS security and warns you before certificates expire. Expired certificates cause browser security warnings that drive visitors away and hurt search rankings.

**Fully automatic** — Just toggle on SSL Check when starting a crawl.
