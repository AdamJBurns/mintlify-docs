...
Find sitemap URLs that no longer exist on your website.

Missing from Site identifies URLs listed in your `sitemap.xml` that **weren't found during the crawl**. These are typically pages that return 404 errors, have been deleted, or are inaccessible—yet they're still declared in your sitemap.
