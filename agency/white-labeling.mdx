...
description: 'Customize Link Health Monitor with your own branding'
icon: 'palette'
---

## Overview

White-labeling allows Agency plan customers to present Link Health Monitor as their own branded solution. Replace our branding with yours on reports, shared links, and client-facing interfaces.
...
|---------|---------------|
| **Logo** | Replace LHM logo with yours |
...
| Element | Customization |
|---------|---------------|
| **Share URLs** | `reports.youragency.com` instead of LHM domain |
...
```
https://app.linkhealthmonitor.com/share/abc123
...
- Link Health Monitor interface (not client-facing)
...
<AccordionGroup>
  ...
  <Accordion title="Emails still show LHM branding">
